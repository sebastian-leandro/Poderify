        ...
        <div className="w-full h-full flex flex-col gap-y-12 justify-center items-center">
          ...
          <div className="w-full flex md:flex-row flex-col h-auto pt-8 justify-center gap-8 px-4 relative">
            ...
            <div className="flex w-fit flex-grow h-auto justify-center m-auto md:justify-start items-end gap-x-8">
              ...
              href={'https://www.linkedin.com/company/poderify/'} className="text-3xl rounded-full duration-300 text-white hover:bg-[rgba(255,255,255,0.5)] p-1 hover:backdrop-blur-3xl">
                <BiLogoLinkedinSquare/>
              </Link>
              <Link 
              aria-label="Instagram link of poderify"
              href={'https://instagram.com/PoderiFy'} className="text-3xl rounded-full duration-300 text-white hover:bg-[rgba(255,255,255,0.5)] p-1 hover:backdrop-blur-3xl">
                <BiLogoInstagram/>
              </Link>
            </div>
            <div className="flex gap-y-4 md:flex-row flex-col p-1 gap-x-8 items-center flex-wrap justify-center md:justify-end md:items-center ">
              ...
              href={'#home'} className="text-white w-fit text-center text-4xl p-2 rounded-full hover:bg-[rgba(255,255,255,.6)] hover:backdrop-blur-3xl duration-500">
              <HiChevronDoubleUp/>
            </Link>
            </div>
          </div>

...
const Hero = () => {
  return (
    <section id="home" className='section flex w-full flex-col min-h-[100vh] bg-image justify-center relative items-center'>
        {hero.map(({title,paragraph,href,link}, i) => (
          <div className="flex flex-col max-w-[580px] items-center  gap-y-6" key={i}>

...
const Services = () => {
  return (
    ...
    >
      <div loading="lazy" className="lg:block hidden gradient-01 w-[250px] h-[250px] bottom-64 left-1"></div>
      <div loading="lazy" className="lg:block hidden gradient top-36 w-[250px] h-[250px]"></div>

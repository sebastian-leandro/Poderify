      ...
      <div className="gradient top-10 left-1"></div>
        <div className='w-full h-auto flex flex-col items-center gap-y-10 justify-center'>
            ...
            <div className="w-full items-center text-center max-w-[600px] justify-center">
                <p className="paragraph-v1 capitalize text-purple-900">Soluciones inteligentes</p>
                <h2 className="heading uppercase">Potencia tu Empresa con Innovación Digital</h2>
                <p className="paragraph-v1 text-[#cecece] mx-auto w-[100%]">Desbloquea el potencial completo de tu negocio. Transformamos datos en decisiones, conectividad en crecimiento, y estrategias en resultados.</p>
            </div>
        </div>

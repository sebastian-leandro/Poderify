...
const CardRow = ({img,alt,title,i}) => {
  ...
  return (
    <motion.div initial="hidden" whileInView="show" variants={fadeIn(i === 0 ? 'left' : 'right', 'spring', 0.4, 0.75 )} className="w-full h-[380px] max-w-[1100px] p-[0.1rem] bg-card rounded-2xl">
